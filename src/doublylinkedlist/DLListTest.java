    ...
    extends TestCase
{
    ...
    /**
     * Tests hasNext and next in iterator for a populated list
     */
    public void testIteratorNextMethods()
    {
        list.add("A");
        list.add("B");
        list.add("C");
    ...
    /**
     * Tests iterator after clearing a populated list
     */
    ...
    /**
     * Tests iterator on a list with one item
     */
    public void testIteratorSingleElementList()
    {
        list.add("A");
        Iterator<String> iter = list.iterator();
        assertTrue(iter.hasNext());
    ...
    /**
     * Extra test method to confirm functional git repository
     */
